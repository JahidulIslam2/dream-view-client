...
const Login = () => {
    return (
                <div className="hero my-20">
                    <div className="hero-content grid md:grid-cols-1 flex-col lg:flex-row gap-6 bg-blue-300 md:p-20 lg:p-20 rounded-lg shadow-xl">
                        ...
                        <form novalidate="" action="" className="space-y-12 ng-untouched ng-pristine ng-valid">
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input type="email" name="email" id="email" placeholder="leroy@jenkins.com" className="w-full px-3 py-2 border rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-black" />
                                </div>
                                <div>
